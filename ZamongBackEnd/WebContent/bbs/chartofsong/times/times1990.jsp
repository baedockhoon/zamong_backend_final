	...
	<div class="container theme-showcase" role="main">
		...
		<div class="page-header">
			<ul class="nav nav-tabs" role="tablist">
        		<li role="presentation"><a href="<c:url value='/ZAMONG/times2010.do'/>">2010년대</a></li>
        		<li role="presentation"><a href="<c:url value='/ZAMONG/times2000.do'/>">2000년대</a></li>
        		<li role="presentation" class="active"><a href="<c:url value='/ZAMONG/times1990.do'/>">1990년대</a></li>
      		</ul>
		</div>
		<!-- 아래에 실제내용 표시 -->
		<h2>1990년대</h2>
