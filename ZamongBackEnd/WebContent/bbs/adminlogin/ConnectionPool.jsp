...
<%
   ...
   */ 
   ...
   //풀 경로로 접근하기
   DataSource source =(DataSource)ctx.lookup(application.getInitParameter("TOMCAT_JNDI_ROOT")+"/jdbc/zamong");
   
   Connection conn= source.getConnection();
   String connString;
   if(conn !=null) connString="<h2>데이타 베이스 연결 성공</h2>";
   else connString="<h2>데이타 베이스 연결 실패</h2>";
