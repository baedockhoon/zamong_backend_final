	...
	<div class="container theme-showcase" role="main">
		...
		<div class="page-header">
			<ul class="nav nav-tabs" role="tablist">
        		<li role="presentation" class="active"><a href="<c:url value='/JAMONG/Balad.do'/>">발라드 차트</a></li>
        		<li role="presentation"><a href="<c:url value='/JAMONG/Dance.do'/>">댄스 차트</a></li>
        		<li role="presentation"><a href="<c:url value='/JAMONG/RapHiphop.do'/>">랩&힙합 차트</a></li>
