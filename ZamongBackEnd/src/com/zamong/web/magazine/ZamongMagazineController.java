...
public class ZamongMagazineController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//페이징용 문자열 생성
		String pagingString = PagingUtil.pagingText(totalRecordCount, pageSize, blockPage, nowPage, req.getServletContext().getContextPath()+"/ZAMONG/zamongMagazine.do?");
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/bbs/magazine/ZamongMagazine.jsp");
		// 포워딩
