...
public class BroadCastListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<BroadCastDTO> list= dao.selectList(map);
		
		//페이징용 문자열 생성
		String pagingString = PagingUtil.pagingText(totalRecordCount, pageSize, blockPage, nowPage, req.getServletContext().getContextPath()+"/ZAMONG/BroadCastList.do?");
...
/*		List listAll=dao.listAll();
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/bbs/zamongtv/Broadcast/BroadCastList.jsp");
